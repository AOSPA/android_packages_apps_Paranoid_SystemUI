...
public class PowerShareTile extends QSTileImpl<BooleanState>
    ...
    private void postUpdatePowerShareState() {
        mBackgroundHandler.post(this::updatePowerShareState);
    }
    ...
    private void updatePowerShareState() {
        ...
        boolean powerShareEnabled = false;
        try {
            powerShareEnabled = mPowerShare.isEnabled();
